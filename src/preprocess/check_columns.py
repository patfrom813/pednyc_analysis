...
# External study archive; override with PEDNYC_DATA_DIR if needed.
DATA_DIR = Path(
    os.environ.get(
        "PEDNYC_DATA_DIR",
        "/export/CAR_WORK/Goedicke_PedestrianXC/Studies",
    )
)
OUT_FILE = PROJECT_ROOT / "data" / "interim" / "csv_dimensions_report.csv"
